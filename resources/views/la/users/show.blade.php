...
<div id="page-content" class="profile2">
		...
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					...
					<div class="row stats">
						<div class="col-md-4"><i class="fa fa-facebook"></i> 0</div>
						<div class="col-md-4"><i class="fa fa-twitter"></i> 0</div>
						<div class="col-md-4"><i class="fa fa-instagram"></i> 0</div>
					</div>
					<p class="desc">Welcome to Olimpiade TI 2017</p>
				</div>
			</div>
		</div>
		<div class="col-md-3">
	...
	<div class="tab-content">
		...
		@if(Entrust::hasRole("SUPER_ADMIN") || Entrust::hasRole("PANITIA"))
		<div role="tabpanel" class="tab-pane fade" id="tab-account-settings">
			<div class="tab-content">
				<form action="{{ url(config('laraadmin.adminRoute') . '/pesertas/change_password/'.$user->context_id) }}" id="password-reset-form" class="general-form dashed-row white" method="post" accept-charset="utf-8">
					{{ csrf_field() }}
					<div class="panel">
						<div class="panel-default panel-heading">
