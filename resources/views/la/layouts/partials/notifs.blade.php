				...
				@else
					...
					<li class="dropdown user user-menu">
						...
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							...
							<img src="{{ asset('la-assets/img/avatar5.png') }}" class="user-image" alt="User Image"/>
						...
						<ul class="dropdown-menu">
							...
							<li class="user-header">
								<img src="{{ asset('la-assets/img/avatar5.png') }}" class="img-circle" alt="User Image" />
								<p>
									{{ Auth::user()->name }}
									<?php
							...
							<li class="user-footer">
								<div class="pull-left">
									<a href="{{ url(config('laraadmin.adminRoute') . '/pesertas/') .'/'. Auth::user()->context_id }}" class="btn btn-default btn-flat">Profile</a>
								</div>
								<div class="pull-right">
									<a href="{{ url('/logout') }}" class="btn btn-default btn-flat">Sign out</a>
								</div>
